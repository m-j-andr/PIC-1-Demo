...
Suppose the number is 314159265, so that the first digit is 3.
 ...
 1. The first method to pick off the first digit involves math.
    <div>
      \[
        3\ =\ \lfloor     3.14159265                                          \rfloor\ 
           =\ \lfloor\frac{314159265}{100000000                              }\rfloor\ 
           =\ \lfloor\frac{314159265}{10^8                                   }\rfloor\ 
           =\ \lfloor\frac{314159265}{10^{\lfloor\log_{10}(314159265)\rfloor}}\rfloor
      \]
    </div>
