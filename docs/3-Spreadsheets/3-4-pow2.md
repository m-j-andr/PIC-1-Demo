...
you are about to see that computers are often far-from-perfect at math!**
 ...
 - In cell `F51`,
   ...
   - Upon hovering over it, you receive a message saying,
     "Invalid: This value does not match the column type **number**".
   - This is confusing!! Why is 1125899906842624 not regarded as a number??
 ...
 - Cells `F51`, `F53`, and `F55`, showed you that
...
If some *text* can be successfully converted to the *number* datatype,
then we can use a function called `VALUE` to obtain this number.
