...
## Preparing the Table
 ...
 - **NOTE.** The parentheses in the previous bullet point introduced a new abbreviation.
...
## Processing Formulas
 ...
 - On 8/3/2025, F1 TV showed the following graphic
   ...
   *for those who watched the race*.
   ...
   However, perhaps you can answer the following questions.
...
We can now understand Formula 1 TV's graphic much better!
 ...
 - "The driver who drives fastest always wins the race." True or false? 
