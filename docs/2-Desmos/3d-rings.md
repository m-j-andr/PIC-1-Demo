...
Estimate the ratio $\frac{r_{ring}}{r_{saturn}}$ where$\ldots$
...
Otherwise, some of the fits dot not work well at all!
 ...
 - $1 < r_{saturn} < 3$ and $4 < r_{ring} < 5$ are sensible constraints.
 - $1 < p_{saturn} < 3$ and $0 < p_{ring} < 3$ are sensible constraints.
