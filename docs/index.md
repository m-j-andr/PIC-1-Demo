# Testing Jekyll Theme, JavaScript, Latex, Pyodide, and Audio Context
...
# 1 - File Management: files, folders, paths, and extensions

[1 - Files](./1-File-Management/1-1-files.md)

[2 - Folders](./1-File-Management/1-2-folders.md)
...
# 2 - Desmos Graphing Calculator: data analysis and curve fitting

[1 - First example](./2-Desmos/2-1.md)

[2 - Second example](./2-Desmos/2-2.md)

[3 - Exercises](./2-Desmos/2-3-exercises.md)
...
[5 - Weighted Averages, a Trip to the Museum, and a Course Grade Calculator](./3-Spreadsheets/3-5-museum.md)
